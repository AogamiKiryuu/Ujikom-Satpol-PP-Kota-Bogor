      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Daftar Peserta</h2>
            <p className="text-gray-600 dark:text-gray-300">Halaman ini akan berisi daftar peserta, fungsi tambah/edit/hapus peserta, dan manajemen data peserta.</p>
          </div>
        </div>
      </main>
    </div>
