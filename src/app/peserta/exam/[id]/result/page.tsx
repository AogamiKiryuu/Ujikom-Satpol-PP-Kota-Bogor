      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-6 text-white shadow-sm border border-white/10 mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div>
              <span className={`inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium border border-white/20 ${result.passed ? 'bg-white/10' : 'bg-white/10'}`}>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-700 dark:text-gray-300">
                      <span className="text-lg font-semibold text-gray-900 dark:text-white">{result.totalEarnedPoints.toLocaleString('id-ID')}</span>
                      <span className="mx-1">/</span>
                      {result.totalPossiblePoints.toLocaleString('id-ID')}
                    </div>
                  </div>
                </div>
              </div>
